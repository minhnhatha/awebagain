...
const textLetterH2 = "Gửi tới các bạn nữ!";
...
const textLetterP = "Nhân ngày 08/03, CLB ITC xin gửi lời chúc tốt đẹp nhất tới tất cả các bạn nữ. Chúc các bạn luôn vui vẻ, hạnh phúc và may mắn trong cuộc sống, ngày càng xinh đẹp, học giỏi và đạt được những điều mình mong muốn. Best wishes for all💗";
